    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.row}>
          ...
          <Text>{report.problemSolving}/10</Text>
        </View>
        <View style={styles.row}>
          <Text>Code Quality</Text>
          <Text>{report.codeQuality}/10</Text>
        </View>
        <View style={styles.row}>
          <Text>Communication</Text>
          <Text>{report.communication}/10</Text>
        </View>
        <View style={styles.row}>
          <Text>Optimization</Text>
          <Text>{report.optimization}/10</Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={{ color: "#6b7280" }}>
          Complexity Analysis: {report.timeComplexity}
        </Text>
      </View>
