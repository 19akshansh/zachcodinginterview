...
interface InterviewQuestionText {
  id: string;
...
export const SessionTextPanel = ({
  ...
  const saveAnswer = useSaveTextAnswer();
  ...
  const meta = interviewTypeMeta[interviewQuestion.question.type];
      ...
      <Card className="p-6 flex flex-col gap-4 bg-secondary/20">
        <div className="space-y-1.5 flex-1 flex flex-col">
          ...
          <p className="text-xs text-muted-foreground/70">
            Answers save automatically as you type and are reviewed by AI once
