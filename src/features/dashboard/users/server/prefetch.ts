...
type GetByIdInput = inferInput<typeof trpc.users.getById>;
...
export const prefetchUserDetail = (params: GetByIdInput) => {
  return prefetch(trpc.users.getById.queryOptions(params));
};
